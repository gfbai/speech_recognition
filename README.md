...
* Specify the location (.mobvoi directory's parent directory) to *mobvoi_sdk_init()* in your program.
  * If you specify NULL to *mobvoi_sdk_init()*, SDK assumes the *.mobvoi* directory is in ../..
...
* You can get more detailed logs by invoking *mobvoi_set_vlog_level()*
  * Invoking mobvoi_set_vlog_level(3) would also record the received PCM audio streams to *.mobvoi/audio_dump/record.pcm*
